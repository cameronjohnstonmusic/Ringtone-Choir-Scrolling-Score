...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 543.0, 150.5, 65.0, 22.0 ],
					"text" : "Play Again"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 543.0, 120.5, 34.0, 22.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 543.0, 90.0, 39.0, 22.0 ],
					"text" : "r fade"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 654.0, 345.5, 540.0, 35.0 ],
					"text" : "jit.gl.text @fontname \"Irish Grover\" @fontsize 36 @layer 2 @gl_color 1. 1. 1. 1. @align 1 @layer 11 @blend_enable 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 50.0, 414.0, 567.0, 22.0 ],
					"text" : "jit.gl.gridshape @shape plane @scale 0.1 0.05 0.1 @name button1 @position 0. 0. 1.5 @blend_enable 1"
				}
