...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 654.0, 34.0, 119.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 48.0, 349.0, 566.0, 35.0 ],
					"text" : "jit.gl.gridshape @shape plane @scale 0.1 0.05 0.1 @layer 1 @name button1 @position 0. 0. 1.5 @layer 10 @blend_enable 1"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-164", 0 ],
					"midpoints" : [ 751.5, 331.75, 57.5, 331.75 ],
					"source" : [ "obj-6", 0 ]
				}
